...
function Card({
  ...
  return (
    <div className="w-full border rounded-lg shadow border-white-900">
      <a>
        <img
      ...
      <div className="py-2 px-5">
        <a href="#">
          <h5 className="mb-2 text-xl md:text-2xl font-bold tracking-tight text-center text-green-600">
            {name}
          </h5>
        </a>
        <div className="mb-3">
        ...
        <p className="mb-3 text-center bg-green-600 font-normal w-fit mx-auto px-4 rounded-lg text-white">
        ...
        {loggedInUser === null ? null : (
          <button
            ...
            className="mb-3 text-center bg-green-600 font-normal w-fit mx-auto px-4 rounded-lg text-white"
          >
            {is ? " Saved" : "*"}
          </button>
        )}
