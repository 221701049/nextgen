      ...
      >
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12 ">
            ...
            <p className="mt-1 text-md leading-6 text-center text-black-600">
                ...
                <div className="mt-2">
                  <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    <input
                      ...
                      id="name"
                      required
                      className="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-green-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-2 space-y-2">
                      ...
                      <button
                        ...
                        className="rounded-md border border-indigo-600 bg-green-600 text-white py-1 px-4 hover:bg-green-700 focus:outline-none focus:ring-none focus:ring-offset-2 focus:ring-green-500"
                      >
                        Add Ingredients
                      </button>
                    </div>
